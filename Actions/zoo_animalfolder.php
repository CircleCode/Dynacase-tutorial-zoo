 ...
 *
 * @author Anakeen 2008
 * @version $Id: zoo_animalfolder.php,v 1.1 2010-01-15 15:15:38 eric Exp $
...
function zoo_animalfolder(&$action) {
  ...
  if ($doc->isAlive()) {
    ...
    if ($doc->fromid != getFamIdFromName($dbaccess,"ANIMAL")) {
    ...
    $fld->setValue("ba_title",sprintf(_("Folder of %s"),$doc->title));
